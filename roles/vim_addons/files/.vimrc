...
let g:markdown_fenced_languages = [ 'ansible=yaml.ansible', 'bash=sh', 'bat=winbatch', 'css', 'dockerfile', 'html', 'Jenkinsfile', 'jinja2', 'ini=dosini', 'json', 'mermaid','nginx', 'ps1', 'python', 'ruby', 'tmux', 'vb', 'vim', 'xml', 'yaml', 'yaml.ansible']
